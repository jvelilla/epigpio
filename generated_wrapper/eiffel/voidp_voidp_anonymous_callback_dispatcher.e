...
class VOIDP_VOIDP_ANONYMOUS_CALLBACK_DISPATCHER
...
feature -- Initialization
	...
	make
		...
		do
			set_voidp_voidp_anonymous_callback_object ($Current)
		end
...
feature -- Access: Dispatcher
	...
	c_dispatcher_1: POINTER
		...
		do
			Result := get_voidp_voidp_anonymous_callback_stub_1
		end
	...
	c_dispatcher_2: POINTER
		...
		do
			Result := get_voidp_voidp_anonymous_callback_stub_2
		end
	...
	c_dispatcher_3: POINTER
		...
		do
			Result := get_voidp_voidp_anonymous_callback_stub_3
		end
...
feature -- Register: Callbacks
	...
	register_callback_1 (a_routine: like routine_1)
		...
		do
			routine_1 := a_routine
			set_voidp_voidp_anonymous_callback_entry_1 ($on_callback_1)
		ensure
	...
	register_callback_2 (a_routine: like routine_1)
		...
		do
			routine_2 := a_routine
			set_voidp_voidp_anonymous_callback_entry_2 ($on_callback_2)
		ensure
	...
	register_callback_3 (a_routine: like routine_1)
		...
		do
			routine_3 := a_routine
			set_voidp_voidp_anonymous_callback_entry_3 ($on_callback_3)
		ensure
...
feature {NONE} -- Implementation
	...
	dispose
		...
		do
			...
			set_voidp_voidp_anonymous_callback_object (default_pointer)
		end
