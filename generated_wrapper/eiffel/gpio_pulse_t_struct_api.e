...
feature {NONE} -- Implementation wrapper for struct gpioPulse_t
	...
	set_c_gpioon (an_item: POINTER; a_value: INTEGER) 
		...
		alias
			"[
				((gpioPulse_t*)$an_item)->gpioOn =  (uint32_t)$a_value
			]"
		ensure
	...
	set_c_gpiooff (an_item: POINTER; a_value: INTEGER) 
		...
		alias
			"[
				((gpioPulse_t*)$an_item)->gpioOff =  (uint32_t)$a_value
			]"
		ensure
	...
	set_c_usdelay (an_item: POINTER; a_value: INTEGER) 
		...
		alias
			"[
				((gpioPulse_t*)$an_item)->usDelay =  (uint32_t)$a_value
			]"
		ensure
